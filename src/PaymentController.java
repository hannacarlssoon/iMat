...
public class PaymentController implements Initializable {
    ...
    private Image oneBlue = new Image("1blue.png");
    private Image oneGrey = new Image("1 grey.png");
    private Image twoBlue = new Image("2 blue.png");
    private Image twoGrey = new Image("2 grey.png");
    private Image threeBlue = new Image("3 blue.png");
    private Image threeGrey = new Image("3 grey.png");
    private Image fourBlue = new Image("4 blue.png");
    private Image fourGrey = new Image("4 grey.png");
    private Image doorGrey = new Image("door grey.png");
    private Image doorBlue = new Image("door blue.png");
    private Image invoiceGrey = new Image("invoice grey.png");
    private Image invoiceBlue = new Image("invoice blue.png");
    private Image ccGrey = new Image("cc grey.png");
    private Image ccBlue = new Image("cc blue.png");
    ...
    //Sets the start page for the payment wizard
    @FXML
